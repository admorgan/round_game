...
// configuration step. It creates a namespace called `round_game`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        round_game::cmake::project_name,
        round_game::cmake::project_version));// version string, acquired
